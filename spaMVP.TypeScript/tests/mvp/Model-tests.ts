...
describe('Model', () => {
    ...
    class TestModel extends spaMVP.Model {
        constructor() {
            super();
        }
    }
    ...
    it('should notify when there is attached listener with given context', () => {
        let model = new TestModel();
        let context = null;
        let action = function () { context = this; };
        let event = 'something';
    ...
    it('should return false when try to detach unattached listener', () => {
        ...
        let result = model.off(spaMVP.ModelEvents.Change, () => -1);
    ...
    it('should return true when successfully detach a listener', () => {
        ...
        let result = model.off(spaMVP.ModelEvents.Change, spy.handler);
    ...
    it('should return true when successfully detach a listener passed with given context', () => {
        ...
        let falsyResult = model.off(spaMVP.ModelEvents.Change, spy.handler);
        let result = model.off(spaMVP.ModelEvents.Change, spy.handler, model);

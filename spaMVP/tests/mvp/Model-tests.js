...
describe("Model", function () {
    ...
    it("should return false when try to detach unattached listener", function () {
        var model = new TestModel();
        var result = model.off(spaMVP.Hidden.Model.Events.Change, function () { return -1; });
    ...
    it("should return true when successfully detach a listener", function () {
        ...
        var spy = jasmine.createSpyObj("spy", ["handler"]);
        model.on(spaMVP.Hidden.Model.Events.Change, spy.handler);
        var result = model.off(spaMVP.Hidden.Model.Events.Change, spy.handler);
    ...
    it("should return true when successfully detach a listener passed with given context", function () {
        ...
        var falsyResult = model.off(spaMVP.Hidden.Model.Events.Change, spy.handler);
        var result = model.off(spaMVP.Hidden.Model.Events.Change, spy.handler, model);
